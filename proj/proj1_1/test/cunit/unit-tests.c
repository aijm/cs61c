...
void test_valid_pixel(){
    CU_ASSERT_TRUE (valid_pixel(0,0,1,1,0,0));
    CU_ASSERT_FALSE (valid_pixel(0,0,1,1,1,1));
    CU_ASSERT_TRUE (valid_pixel(1,1,3,3,1,1));
    CU_ASSERT_FALSE (valid_pixel(0,0,3,3,1,1));
    CU_ASSERT_FALSE (valid_pixel(0,1,3,3,1,1));
    CU_ASSERT_FALSE (valid_pixel(0,2,3,3,1,1));
    CU_ASSERT_FALSE (valid_pixel(1,0,3,3,1,1));
    CU_ASSERT_FALSE (valid_pixel(1,2,3,3,1,1));
    CU_ASSERT_FALSE (valid_pixel(2,0,3,3,1,1));
    CU_ASSERT_FALSE (valid_pixel(2,1,3,3,1,1));
    CU_ASSERT_FALSE (valid_pixel(2,2,3,3,1,1));
...
int main () {
    ...
    if (!CU_add_test (pSuite, "valid pixel test", test_valid_pixel)) {
        goto exit;
    }
